...
const files = [
  ...
  'recipes/merge/art-v1/catalog-runtime.mjs',
  'scripts/build-merge-catalog-runtime.mjs',
  'scripts/qa-merge-catalog-runtime.mjs',
  'scripts/promote-merge-catalog-runtime.mjs',
